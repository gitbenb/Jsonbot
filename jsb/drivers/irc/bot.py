...
class IRCBot(Irc):
    ...
    def _dccloop(self, sock, nick, userhost, channel=None):
        ...
        while 1:
            ...
            try:
                ...
                logging.warn("%s got %s (%s)" % ( userhost, res.strip(), self.cfg.name))
    ...
    def kick(self, channel, nick, reason=None):
        ...
        self.sendraw('KICK %s %s :%s' % (channel, nick, reason))
    ...
    def handle_311(self, ievent):
        ...
        self.userhosts[nick.lower()] = userhost
    ...
    def handle_352(self, ievent):
        ...
        logging.debug('%s - adding %s to userhosts: %s' % (self.cfg.name, nick, userhost))
        self.userhosts[nick.lower()] = userhost
        self.nicks[userhost.lower()] = nick
